      ...
      <div class="row">
        <div class="col-md-9 col-lg-7 col-xl-5 mx-auto">
          ...
          <div class="bg-white shadow-md rounded p-3 pt-sm-4 pb-sm-5 px-sm-5">
            ...
            <h4 class="text-5 text-center mt-3"><span>Senha alterada com sucesso!</span></h4>
            <p class="lead text-4 text-center">Volte para a página de login e realize seu acesso!</p>
