  ...
  <div class="login-box">
    ...
    <div class="card">
      <div class="card-body login-card-body">
        ...
        <form action="" method="POST">
          ...
          <div class="row mb-3">
            <div class="col">
              ...
              <div class="text-dark text-5 text-center rounded p-2" style="background: #a5b5c5; width: 100%; height: 52px;">
        ...
        <p class="mb-0">
          <a href="signin" class="text-center">Já tenho cadastro, Fazer login</a>
        </p>
      </div>
      <!-- /.login-card-body -->
    </div>
